          ...
          <div className="mt-8 text-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button 
                ...
                disabled={loading}
                className="flex items-center justify-center gap-2 px-4 py-2 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors font-medium text-black text-sm disabled:opacity-50"
              >
